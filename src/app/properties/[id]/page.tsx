                            ...
                            <div className="sticky top-32 p-10 bg-neutral-800 rounded-large border border-neutral-700 shadow-custom">
                                ...
                                <form className="space-y-6" onSubmit={e => e.preventDefault()}>
                                    <div>
                                        ...
                                        <select className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-4 rounded-small shadow-sm focus:outline-none focus:border-secondary-400 transition-all text-sm appearance-none cursor-pointer">
                                    ...
                                    <div>
                                        <input type="text" placeholder="Full Name" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-4 rounded-small shadow-sm focus:outline-none focus:border-secondary-400 transition-all text-sm placeholder-neutral-600" />
                                    </div>
                                    <div>
                                        <input type="email" placeholder="Email Address" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-4 rounded-small shadow-sm focus:outline-none focus:border-secondary-400 transition-all text-sm placeholder-neutral-600" />
                                    </div>
                                    <div>
                                        <input type="tel" placeholder="Phone Number" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-4 rounded-small shadow-sm focus:outline-none focus:border-secondary-400 transition-all text-sm placeholder-neutral-600" />
                                    </div>
                                    <motion.button
                                        whileHover={{ scale: 1.02, y: -2 }}
                                        whileTap={{ scale: 0.98 }}
                                        className="w-full bg-gradient-to-r from-secondary-400 to-secondary-600 text-neutral-900 font-bold py-5 rounded-small shadow-xl transition-all"
                                    >
