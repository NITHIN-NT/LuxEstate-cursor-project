                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3.5 rounded-small focus:outline-none focus:border-secondary-400 transition-all placeholder-neutral-500" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-neutral-400 mb-2 font-body">Phone Number</label>
                      <input type="tel" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3.5 rounded-small focus:outline-none focus:border-secondary-400 transition-all placeholder-neutral-500" placeholder="+1 (555) 000-0000" />
                    </div>
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-neutral-400 mb-2 font-body">Email Address</label>
                    <input type="email" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3.5 rounded-small focus:outline-none focus:border-secondary-400 transition-all placeholder-neutral-500" placeholder="john@example.com" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-neutral-400 mb-2 font-body">I&apos;m Interested In</label>
                    <div className="relative">
                      <select className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3.5 rounded-small focus:outline-none focus:border-secondary-400 transition-all appearance-none cursor-pointer">
                  ...
                  <div>
                    ...
                    <textarea rows={4} className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3.5 rounded-small focus:outline-none focus:border-secondary-400 transition-all placeholder-neutral-500 resize-none" placeholder="Tell us about your requirements..."></textarea>
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full bg-gradient-to-r from-secondary-400 to-secondary-600 text-neutral-900 font-bold py-4.5 px-6 rounded-small shadow-lg transition-all text-lg"
                  >
                    Submit Request
                  </motion.button>
                </form>
